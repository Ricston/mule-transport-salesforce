/*
 * $Id: SalesforceHybridInvocationsTestCase.java 1498 2011-10-03 11:08:18Z claude.mamo $
 * --------------------------------------------------------------------------------------
...
public class SalesforceHybridInvocationsTestCase extends AbstractSalesforceFunctionalTestCase
{
    ...
    public void testLoginQuery() throws Exception
    {
        ...
        MuleMessage msg = client.send("vm://test.login.query", new DefaultMuleMessage(payload, muleContext));
