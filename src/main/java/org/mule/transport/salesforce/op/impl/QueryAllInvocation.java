/*
 * $Id: QueryAllInvocation.java 1036 2010-11-24 08:47:10Z jcalleja $
 * --------------------------------------------------------------------------------------
...
/**
 * QueryAllInvocation requires a MuleMessage with a payload which contains a String
 * and a String (the sessionId) as the first and second parameter respectively.
 */
public class QueryAllInvocation extends AbstractInvocation
{

    public QueryAllInvocation(GenericKeyedObjectPool soapBindingPool, Object[] invocationParameters)
    {
    ...
    public Object invoke() throws Exception
    {
        ...
        try
        {
            ...
            {
                logger.debug("Before executing queryAll: queryString = " + queryString + ", sessionId = "
                             + sessionId);
            }

            queryResult = sfdc.queryAll(queryString);
