/*
 * $Id: UpdateInvocation.java 1036 2010-11-24 08:47:10Z jcalleja $
 * --------------------------------------------------------------------------------------
...
/**
 * UpdateInvocation requires a MuleMessage with a payload which contains a SObject[]
 * and a String (i.e. the sessionId) as the first and second parameter respectively.
 */
public class UpdateInvocation extends AbstractInvocation
{

    public UpdateInvocation(GenericKeyedObjectPool soapBindingPool, Object[] invocationParameters)
    {
    ...
    public Object invoke() throws Exception
    {
        ...
        try
        {
            ...
            {
                logger.debug("Before executing update: sessionId = " + sessionId);
            }

            result = sfdc.update(sObjects);
