/*
 * $Id: GetUserInfoInvocation.java 1036 2010-11-24 08:47:10Z jcalleja $
 * --------------------------------------------------------------------------------------
...
/**
 * GetUserInfoInvocation requires a MuleMessage with a payload which contains a
 * String (i.e. the sessionId).
 */
public class GetUserInfoInvocation extends AbstractInvocation
{

    public GetUserInfoInvocation(GenericKeyedObjectPool soapBindingPool, Object[] invocationParameters)
    {
    ...
    public Object invoke() throws Exception
    {
        ...
        try
        {
            ...
            {
                logger.debug("Before executing getUserInfo: SessionId = " + sessionId);
            }

            result = sfdc.getUserInfo();

            if (logger.isDebugEnabled())
            {
                logger.debug("After executing getUserInfo: SessionId = " + sessionId);
            }
        }
        finally
        {
